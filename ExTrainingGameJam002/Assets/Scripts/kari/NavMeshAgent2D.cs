...
public class NavMeshAgent2D : MonoBehaviour
{
    ...
    private void Trace(Vector2 current, Vector2 target)
    {
        ...
        // Update total distance traveled while moving along the path
        float distanceToCorner = Vector2.Distance(current, corner);
        totalDistanceTraveled += distanceToCorner;
